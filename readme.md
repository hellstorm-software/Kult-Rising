...
[![Last Commit](https://img.shields.io/github/last-commit/hellstorm-software/Kult-Rising?color=f204ff&label=&style=for-the-badge&display_timestamp=committer)](https://github.com/hellstorm-software/Kult-Rising/pulse/monthly "Last activity")
...
<p style="font-size: smaller;">
    ...
    the <b>LORE, CHARACTERS, and EVENTS</b> of this game are liscenced under <a href="http://sxlaris.wikidot.com/licensing-and-third-party-content"> CC BY-SA</a><br>
...
2026.1.25
- added Therapist NPC
    - added basic medical items to trades
- added concrete material to the stacks
- added another orb field to the starting island
- adjusted grand exchange room to be shorter
- created medical box container 
- adjusted volume level of ashlands wind so the tower isnt silent
- added sound effects to tool impacts
...
- updated the main island of the ashlands
    - added 2 orb fields
    - added 1 petrified blocks
- added sledgehammer weapon
    - added 'MISERY' reference to sledghammer description
    - changed durability to 20 (allows to break 4 cement blocks)
    - added sledge hammer world item
- added new cement damagable
    - fixed an issue allowing firearms to damage cement blocks
    - added cement blocks to save system
    - changed healthpool to 100 (5 sledge hits to break)
...
- updated the grand exchange
    - finished Fence's trading station
        ...
        - added barrels
        - added 2 tarps
        - added 2 screw storage containers
        - added case of bottles
        - added ammo box
    - began adding Therapist's trading station
        - added potion holder
        - added 2 paintings
        - moved carboard boxes from Fence to Therapist
        - added tarp
        - added radio
        - added vase
        - added inkwell
...
- added wind sounds to the ashlands
    ...
    - added indoor and outdoor checks so base doesn't have ambient sound
- optimized method of calculating physics in the ashlands, dramatically improved framerate
- fixed an issue causing strange collisions at the base of the tower

----------------------------------------------------------

2026.1.10
- created fully functioning orb field
    - cleaned up orb field expanding and growing animation
    - added new materials to orbs
    - fixed a rendering issue causing weird artifacting around the edges of the orbs
    - added rotation to the orbs
        - added variance to the rotation
    - created random spawn system
    - fixed an issue causing some orbs to not rotate
...
- began creating clothing upgrade machine
    - created refined tracksuit jacket
        - changed icon background to blue
    - created advanced tracksuit jacket
        - changed icon background to red
    - created refined leather jacket
    - created advanced leather jacket
    - created clothing upgrade recipes
...
- began creating orb field anomalies
    - created orb mesh
...
- adjusted size of players pockets
...
- updated cluster 2
    ...
    - fixed a gap in the bottom floor
- updated cluster 3
    - removed text from spawn room 
    - removed extra lights
    - adjusted cull distance of lights
    - cleaned up geometry in the big room
    - fixed gap in the ceiling of the big room
    - fixed an area with a clipping ceiling at the top of the stairs

----------------------------------------------------------

2026.1.5 - 2026.1.6
- added small dresser item (4x3 w 24)
    - added open and close animations
- added wardrobe item (4x7 w 48)
- added wooden shelves item (4x7 with 6 7x1s)
- added new custom grid with 6 7x1 rows
- added new custom grid with 3 7x2 rows
- added storage bin item (2x2)
    - added storage bin to build parts
    - created lootable world bin
    - created a new bin material
- added composter item (3x2)
- adjusted shirt sizes
    - tracksuit: 2x3 to 3x4
    - leather: 2x3 to 4x4
    - firefighter: 3x4 to 4x5
    - cloth shirt: 2x1 to 3x1
    - tshirt: 2x1 to 3x1
- added new inventory icons
    - added new helmet slot icon
    - added new headset icon
    - added new armor slot
    - moved gloves slot to cosmetics area
    - added cosmetic mask slot
    - added cosmetic shirt slot
    - added new jacket icon
    - added new boots icon
- added new gear icons
- updated bookshelf storage to 3 7x2 layout
- adjusted player crafting recipes
    - removed crafting table
    - removed bandage
    - removed G4 backpack
    - added cloth backpack
- adjusted crafting table recipes 
    - removed table recipe
- adjusted log size to 2x5 (was 2x3)
- adjusted wood size to 2x2 (was 1x2)
- adjusted meat size to 2x2 (was 1x1)
- adjusted blunt size to 1x1 (was 1x2)
...
- added vintage cupboard item
    ...
    - added cupboard mesh
    - fixed an issue causing infinite cupboards
- began creating grand exchange
    - added door between tower and exchange
    - added materials to stack mesh
    - fixed an issue with collisions in the exchange
    - began adding lighting
- added new kind of door
- added divider to expandable section of the base
- created new world aligned carpet material
- added spotlight to apartment building
- began furnishing apartment building
- added lighting to lootable building to the east
- began overhauling UI
    - created new helmet icon
    - created a headset icon
    - created a mask icon
    - created new shirt icon
    - created new pants icon
    - created new shoes icon
    - created new equipped item icon
...
- added refrigerator item
    - added fridge to build parts
    - created lootable world fridges
    - added fridge mesh
- began adding lootable buildings to the main island
- added cabinet item
    - added cabinet to build parts
    - created lootable cabinet items
    - added cabinet mesh
- added stove item
    - added stove to build parts
    - created stover interaction item
    - added stove mesh
- added bookshelf item
    - added bookshelf to build parts
    - created lootable bookshelf item
    - added bookshelf mesh
- created second lootable building
    - added furniture
- created a new black plaster material
- added apartment building to main island
    - adjusted foliage around apartment
    - slightly increased the scale of all aparment buildings
...
2025.12.28
- began building out the tower elevator
    - switched old interaction panel to new interaction system
    - began creating elevator menu UI
- began adding echo mech
    - added turrets to mech
...
- began overhauling UI
    ...
    - fixed an issue causing some UI menus to not be centered
...
- finished level 1 of the tower milestones
    ...
    - updated the interaction text for more clarity
    - updated milestone display materials
- began adding level 2 of the tower milestones
    - integrated into the save system
    - fixed an issue causing level 2 display to not appear upon completing level 1
    - fixed an issue that caused the level 2 display to disappear befofe being completed 
...
- added a 5th stack to the ashlands directly behind the tower
    ...
    - adjusted position of stack 5 to make room for an elevator connecting it to the tower
- added several echo spawn points in the forgotten city 
- added the first extraction point in the north west corner of the map
- removed foundations at the bottom of the tower
- removed and replaced all the trees on the main island (lowered density by about 30%)
- lowered the total amount of wood per tree
...
- began creating Ashlands Replikate system
    - created replikate spawn points
- began blocking out the forgotten city in the ashlands
    ...
    - added larger collapsed bridge (N/S)
- added dwarven statue to the north east corner of the ashlands
- updated [wiki](http://sxlaris.wikidot.com)
- began expanding Cluster 8
    - filled in the hallway of the previous expansion
    - added new chamber to the end of the hallway
...
- began creating the tower milestone system
    ...
    - *fixed an issue causing the resource counter to enter an infinite loop and crash*
...
- updated the ashlands
    - began creating quantum storage
...
Known Issues:
- Log holder inventory will not save

----------------------------------------------------------
2025.12.1 - 2025.12.3
- adjusted most textures to be world aligned
- updated Ashlands tower
    - updated tower materials
    - added indicator panel for tower facilities
    - reintegrated old elevator door to new interaction system
    - began adding store
- added harvestable bushes to the ashlands
- added VPO-215 rifle
- added DZ-18 rifle
...
- *all pistols use the M1911 model when being held*
...
- updated [wiki](http://sxlaris.wikidot.com)
    - updated [canon](http://sxlaris.wikidot.com/canon)
    - updated SCP-x014
    - added SCP-x011
    - added SCP-x019
    - added SCP-x021
    ...
    - added SCP-x137
    - added SCP-x139
    - ported [the 784 incident](http://sxlaris.wikidot.com/784-incident-part-1)
        - ported part 1
        - ported part 2
        - ported part 3
        - ported part 4
...
- continued working on the first draft of [Convergence (Web Comic)](http://sxlaris.wikidot.com/canon)
    ...
    - updated draft page 4
    - updated draft page 5

----------------------------------------------------------

2025.11.15 - 2025.11.20
- updated [wiki](http://sxlaris.wikidot.com)
    - added [POI Hub](http://sxlaris.wikidot.com/poi-hub)
        - added description
...
2025.11.12
- began building cluster 19 (the museum)
    - blocked out main floor
    - blocked out center area of second floor
- updated [wiki](http://sxlaris.wikidot.com)
    - added [locations hub](http://sxlaris.wikidot.com/locations-hub)
        - adjusted formatting
        - removed extra locations
    - added [SCP-x008](http://sxlaris.wikidot.com/scp-x008)

----------------------------------------------------------

2025.11.10
- added dev chests
- reintegrated drone idle game
    ...
    - began creating a save system for the drones
        - added obsidian to save system
        - added cannabis to save system
    ...
    - added crying obsidian mesh
    - *fixed an issue when creating a new drone, causing the drone to spawn, but not be placed in the crate*
- created the selfie cam for cinematics
- began creating SCP-970-1 Cluster
    - added basic room/hallway layout
    - added logic to create an infinite hallway
...
2025.11.8
- changed Cluster 1 to Cluster 0
- began working on a new cluster 1 (total walkthrough time is 2 minutes)
    - added spawn room
        - added railings
    - added level 8 section
    ...
    - consolidated and optimized the main set of Backrooms materials
 - expanded Cluster 1
     - finished main curtain room
     - added ceiling to the first floor
     - adjusted Nidavellir lookthrough
     - added a second Nidavellir lookthrough on the upper floor
     - added large Level 1 section
...
2025.11.6
- began working on Kult Raiders
    - began creating the bunker
        - created the expandable bunker walls
        - added staircase
        - began creating bunker door
        - added a second tier of expandable walls
- extended cluster 1 of Kult: Freerunners
    ...
    - *fixed an issue that caused player's legs to be out of view when sliding*
    - adjusted grappling hook range
    - added cooldown to doublejump
...
2025.11.4
- began working on Kult: Freerunners
...
- finished Midnight Gas V. 1.1
    ...
    - adjusted demo menu
    - fixed an issue that caused the game to return to the menu after the intro cutscene
    - packaged the game (this shit is finally finished. why did i decide to make an entire game in 11 days without using any parts of the game id already built? couldn't tell you, but thats what i did)
...
- finished Midnight Gas V. 1.0
    ...
    - updated cluster 2
        ...
        - added ambient sounds to cluster 2
        - added several collectible SCP-131s to cluster 2
        - added some extra lights
    - overhauled SCP-173 movement logic
...
- began adding the grassrooms to cluster 4 (current walkthrough time is 6 minutes)
    ...
    - added large overhead lighting
    - added basic geometry layout
    - added exit within a tunnel of the cutaway (current walkthrough time is 1 mintue)
- began working on SCP-3008
    - added wood material
...
- added SCP-173 movement system
    ...
    - *fixed an issue that caused SCP-173 to move at the normal player speed*
- completed full gas station logic sequence
    - added NoClip zone logic system
    - added SCP-173 spawn to end of soldier dialogue 

----------------------------------------------------------

2025.10.26
- completed base functionality of gas station AI locomotion system (still needs smoothed out)
    - added civilians to locomotion system
    - added junkies to locomotion system
    - added Caseoh to locomotion system
    - added D-Class to locomotion system 
    - added soldiers to locomotion system
- added blue haired girl dialogue
- added D-Class dialogue
- added grocery props to cutomer checkout interaction system for visual feedback of player actions
- *fixed an issue that caused the blue hair girl's dialogue box to not be accessible more than once*
- *fixed an issue that caused the first shift to not start under certain circumstances*
...
- Created gas station AI system
    - created civilian
        - added civilian model
        - added civilian shopping logic
        - added civilian to game system
    - created junkie
        - added junkie model
        - connected junkie to shopping logic
        - added junkie to game system
    - created soldier
        - added soldier models
        - added soldiers to dialogue system
    - created DClass
    - created manager
        - added manager to dialogue system
- hooked gas station AI into dialogue system
- added the blue haired girl
    - connected blue haired girl up to dialogue system
- began working on cutscenes
    - began creating manager cutscene
    - began working on soldier cutscene
- built gas station game sequence out from start, through third customer
...
- updated flashlight light to be more realistic (and brighter)
...
- finished 99% of gas station map
    - added extension to the back corner of the convenience store
    - doubled the height of the shelves
    - filled in all of the shelves with product
    - created civilian systems for shopping at gas station
        - created civilian shopping pathing
        - created civilian purchase/checkout system
        - created stocking shelves system
    - added stockable shelves to the gas station
    - fixed issues with gas station interior geometry
    - began building water park across the street
        - created base building
        - added roofing
        - added front sign
        - added road
   - updated VHS display
       - added cinema poster above display
       - added 3 new VHS tapes
   - adjusted interior lighting

----------------------------------------------------------

2025.10.21
- mostly finished gas station level
    - restructured and expanded gas station interior
    - added shelves
    - added 2 vending machines
    - added refrigerated shelves
    - added products to shelves
    - began creating dialogue system
    - began adding VHS display
- *fixed an issue causing lighting issues in the gas station level*
- *fixed an issue causing an unintended collision when entering gas station*

----------------------------------------------------------

2025.10.20
- mostly finished cluster 2 (current walkthrough time is 20 minutes)
    - finished wall furnishings on floor 2
    - added ceiling to floor 2
    - added some extra lighting to floor 2
...
- updated sandbox level
    - added text boxes explaining several features/areas
...
- expanded cluster 2 (current walkthrough time is 14 minutes)
    - slightly expanded floor 1
        - added ceiling to new sections
    - massively expanded floor 2
        - added ~8 new rooms and connecting hallways
        - began adding wall furnishings
        - connected all the sections of floor 2
        - adjusted overlook into floor 1 main hall to be more subtle from the first floor
...
- massively expanded cluster 2 (current walkthrough time is 10 minutes)
    - finished floor 1
        - added wall furnishings
        - added pillars
        - added curtains
        - added 2 staircases leading to the second floor
        - added the ceiling
    - began making floor 2
        - built the entry hall
        - built the gallery
        - built the outer hall
        - built the 3 way
        - began connecting all the sections of floor 2
        - began adding wall furnishings

----------------------------------------------------------

2025.10.12 - 2025.10.13
- began creating cluster 2 (current walkthrough time is 3 minutes)
