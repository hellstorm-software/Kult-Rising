...
- changed the tower expansion upgrade. Now only half of the expansion is unlocked via the milestone system. The other half is accessable via using sledgehammers to remove the cement
